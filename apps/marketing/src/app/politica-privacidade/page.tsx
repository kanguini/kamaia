    ...
    <>
      ...
      <main className="bg-white text-neutral-900">
        ...
        <section className="py-16">
          <article className="shell max-w-3xl space-y-10 text-[15px] leading-relaxed text-neutral-700 [&_h2]:text-2xl [&_h2]:font-medium [&_h2]:text-neutral-900 [&_h2]:tracking-[-0.02em] [&_h2]:mt-8 [&_h3]:text-lg [&_h3]:font-medium [&_h3]:text-neutral-900 [&_h3]:mt-4 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-2 [&_p]:text-neutral-600 [&_a]:text-neutral-900 [&_a]:underline [&_a]:underline-offset-4">
