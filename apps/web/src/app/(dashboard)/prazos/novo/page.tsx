        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div>
            <label className="block text-sm font-mono font-medium text-ink mb-2">
              Processo <span className="text-error">*</span>
            </label>
            {processos.length === 0 ? (
              ...
              <select
                ...
                className={cn(
                  ...
                  errors.processoId ? 'border-error' : 'border-border',
                )}
              >
            ...
            {errors.processoId && (
              <p className="text-error text-sm mt-1">{errors.processoId.message}</p>
            )}
          </div>
          ...
          {showLegalSuggestion && (
            <div className="bg-bone border border-border-strong rounded-lg p-4">
