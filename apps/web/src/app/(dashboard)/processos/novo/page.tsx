            ...
            <div className="space-y-6">
              ...
              {clientes.length === 0 ? (
                <div className="bg-warning/10 border border-warning/20  p-6 text-center">
                  ...
                  <Link
                    href="/clientes/novo"
                    className="inline-flex items-center gap-2 [background:var(--color-btn-primary-bg)] [color:var(--color-btn-primary-text)] font-medium px-6 py-2.5  hover:[background:var(--color-btn-primary-hover)] transition-colors"
                  >
          ...
          <div className="flex items-center gap-4 pt-4">
            ...
            {step < 5 ? (
              <button
                ...
                disabled={!canProceed()}
                className={cn(
                  'flex-1 flex items-center justify-center gap-2 [background:var(--color-btn-primary-bg)] [color:var(--color-btn-primary-text)] font-medium py-2.5 ',
