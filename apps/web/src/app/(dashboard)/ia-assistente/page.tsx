              ...
              {quotaExhausted ? (
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className={cn(
                      'w-12 h-12 rounded-full [background:var(--color-btn-primary-bg)] [color:var(--color-btn-primary-text)] flex items-center justify-center',
                      'hover:[background:var(--color-btn-primary-hover)] transition-colors flex-shrink-0',
